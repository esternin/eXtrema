...
*/
#ifndef WriteScalarsFormH
#define WriteScalarsFormH
...
class TWriteScalForm : public TForm
{
...
public:		// User declarations
  __fastcall TWriteScalForm(TComponent* Owner);
  __fastcall ~TWriteScalForm();

};

extern PACKAGE TWriteScalForm *WriteScalForm;
