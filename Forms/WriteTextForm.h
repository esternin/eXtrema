...
*/
#ifndef WriteTextFormH
#define WriteTextFormH
...
class TWriteTxtForm : public TForm
{
...
public:		// User declarations
  __fastcall TWriteTxtForm(TComponent* Owner);
  __fastcall ~TWriteTxtForm();

};

extern PACKAGE TWriteTxtForm *WriteTxtForm;
