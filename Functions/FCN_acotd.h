...
class FUNCTIONS_LINKAGE_ FCN_acotd : public ScalarFunction
{
public:
  static FCN_acotd *Definition()
  { return &fcn_acotd_; }
  
  void ScalarEval( int j, std::vector<double> &rStack ) const
  { rStack[j] = atan( 1.0/rStack[j] )*180./M_PI; }

private:
  FCN_acotd() : ScalarFunction( "ACOTD" )
  {}
  
  static FCN_acotd fcn_acotd_;
};
