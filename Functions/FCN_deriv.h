...
class FUNCTIONS_LINKAGE_ FCN_deriv : public ArrayFunction
{
public:
  static FCN_deriv *Definition()
  { return &fcn_deriv_; }
...
private:
  FCN_deriv() : ArrayFunction( "DERIV", 2, 3, MIXED2NUM, NUMERIC, NUMERIC, CHARACTER )
  {}
