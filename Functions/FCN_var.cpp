...
void FCN_var::ArrayEval( Workspace *ws )
{
  ...
  if( arg1->IsaNVariable() )
  {
    ...
    if( ndm1 != 1 )
    {
      if( numberOfArguments_ == 1 )
        throw EExpressionError( "VAR: argument must be a vector" );
      else
        throw EExpressionError( "VAR: argument 1 must be a vector" );
    }
  ...
  else if( arg1->IsaWorkspace() )
  {
    ...
    {
      if( numberOfArguments_ == 1 )
        throw EExpressionError( "VAR: argument workspace is empty" );
      else
        throw EExpressionError( "VAR: argument 1 workspace is empty" );
    }
  ...
  if( numberOfArguments_ == 2 )
  {
    ...
    if( arg2->IsaNVariable() )
    {
      ...
      if( ndm2 != 1 )
        throw EExpressionError( "VAR: argument 2 must be a vector" );
    ...
    else if( arg2->IsaWorkspace() )
    {
      ...
      if( w->IsEmpty() )
        throw EExpressionError( "VAR: argument 2 workspace is empty" );
  ...
  if( numberOfArguments_ == 2 )
  {
    ...
    //
    if( size1 != size2 )
      throw EExpressionError( "VAR: arguments must have the same length" );
    ...
    if( wsum == 0.0 )
      throw EExpressionError( "VAR: sum of the weights = 0" );
