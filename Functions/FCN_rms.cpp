...
void FCN_rms::ArrayEval( Workspace *ws )
{
  ...
  if( arg1->IsaNVariable() )
  {
    ...
    if( ndm1 != 1 )
    {
      if( numberOfArguments_ == 1 )
        throw EExpressionError( "RMS: argument must be a vector" );
      else
        throw EExpressionError( "RMS: argument 1 must be a vector" );
    }
  ...
  else if( arg1->IsaWorkspace() )
  {
    ...
    {
      if( numberOfArguments_ == 1 )
        throw EExpressionError( "RMS: argument workspace is empty" );
      else
        throw EExpressionError( "RMS: argument 1 workspace is empty" );
    }
  ...
  if( numberOfArguments_ == 2 )
  {
    ...
    if( arg2->IsaNVariable() )
    {
      ...
      if( ndm2 != 1 )
        throw EExpressionError( "RMS: argument 2 must be a vector" );
    ...
    else if( arg2->IsaWorkspace() )
    {
      ...
      if( w->IsEmpty() )
        throw EExpressionError( "RMS: argument 2 workspace is empty" );
  ...
  if( numberOfArguments_ == 2 )
  {
    ...
    //
    if( size1 != size2 )
      throw EExpressionError( "RMS: arguments must have the same length" );
    ...
    if( wsum == 0.0 )
      throw EExpressionError( "RMS: sum of the weights = 0" );
  }
  ...
  if( rms/wsum < 0.0 )
    throw EExpressionError( "RMS: rms/(sum of weights) < 0" );
