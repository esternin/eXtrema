...
*/
#ifndef EXTREMA_READSCALARSFORM
#define EXTREMA_READSCALARSFORM
...
class ReadScalarsForm : public wxFrame
{
public:
  ReadScalarsForm( AnalysisWindow * );
...
private:
  ...
  wxTextCtrl *errorFillTextCtrl_, *formatTextCtrl_, *lineNumberTextCtrl_;
  wxStaticText *lineNumberText_;
