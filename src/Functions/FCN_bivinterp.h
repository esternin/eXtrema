...
{
public:
  static FCN_bivariateInterpolate *Instance()
  {
    if( !fcn_bivariateInterpolate_ )fcn_bivariateInterpolate_ = new FCN_bivariateInterpolate();
...
private:
  FCN_bivariateInterpolate() : ArrayFunction( wxT("BIVINTERP"), 5, 5 )
  {}
