...
GRA_plus::GRA_plus( double xc, double yc, double side, double angle,
...
std::ostream &operator<<( std::ostream &out, GRA_plus const &mlf )
{
  out << wxT("<plus xc=\"") << mlf.xc_ << wxT("\" yc=\"") << mlf.yc_
