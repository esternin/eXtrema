...
*/
#ifndef GRA_SIZECHARACTERISTIC
#define GRA_SIZECHARACTERISTIC
...
class GRA_sizeCharacteristic : public GRA_characteristic
{
public:
  GRA_sizeCharacteristic( wxChar const *name, double value, bool percent, double min, double max )
      : GRA_characteristic(name,SIZE,false),
        min_(min), max_(max), value_(value), setAsPercent_(percent), default_(value)
  {}

  GRA_sizeCharacteristic( wxChar const *name, std::vector<double> const &values, bool percent,
                          double min, double max )
      : GRA_characteristic(name,SIZE,true),
  ...
  GRA_sizeCharacteristic( GRA_sizeCharacteristic const &rhs ) : GRA_characteristic(rhs)
  { CopyStuff( rhs ); }

  GRA_sizeCharacteristic &operator=( GRA_sizeCharacteristic const &rhs )
  {
  ...
  friend std::ostream &operator<<( std::ostream &, GRA_sizeCharacteristic const & );

private:
  void CopyStuff( GRA_sizeCharacteristic const & );
  //
