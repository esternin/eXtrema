...
GRA_crossPlus::~GRA_crossPlus()
{}

GRA_crossPlus::GRA_crossPlus( double xc, double yc, double side, double angle,
...
std::ostream &operator<<( std::ostream &out, GRA_crossPlus const &mlf )
{
  out << wxT("<crossplus xc=\"") << mlf.xc_ << wxT("\" yc=\"") << mlf.yc_
