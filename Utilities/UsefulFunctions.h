...
{
  void LeastSquaresFit( Expression *, ExString &,
  ...
  double RacahCoefficient( double, double, double, double, double, double );
  ...
  void SavGol( std::vector<double> &, std::size_t, std::size_t, std::size_t, std::size_t );
