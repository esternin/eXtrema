...
public:
  GRA_cartesianAxes()
    : GRA_drawableObject("CARTESIANAXES"), xAxis_(0), yAxis_(0), boxXAxis_(0), boxYAxis_(0)
  {}
...
private:
  ...
  void DrawXLabel( GRA_outputType * );
  void DrawYLabel( GRA_outputType * );
  void GetActualValues( double &, double &, double );
  void ResetLogValue( double &, double );
  void FixupScales( bool, bool, double, double, double, int &, double &, double &,
                    double &, GRA_setOfCharacteristics *, bool );
