...
#ifdef BUILDING_GRAPHICS_DLL_
#define GRAPHICS_LINKAGE_ __declspec(dllexport)
#else
#define GRAPHICS_LINKAGE_ __declspec(dllimport)
#endif

class GRAPHICS_LINKAGE_ GRA_thiessenTriangulation
{
public:
