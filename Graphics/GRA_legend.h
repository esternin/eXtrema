...
public:
  GRA_legend( GRA_window *gw )
    : GRA_drawableObject("GRAPHLEGEND"), graphWindow_(gw), frame_(0), title_(0), popup_(false)
  { Initialize(); }
...
{
public:
  GRA_legendEntry( GRA_legend*, ExString const &, double, GRA_font*, GRA_color*, int,
