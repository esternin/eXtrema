...
public:
  ...
  GRA_window &GRA_window::operator=( GRA_window const &rhs )
  {
  ...
  void Clear();
  void Erase();
  void DisplayBackground( GRA_outputType * );
  ...
  void SetXAxisCharacteristics( GRA_setOfCharacteristics const &c )
  { *xAxisCharacteristics_ = c; }

  void SetYAxisCharacteristics( GRA_setOfCharacteristics const &c )
  ...
  void PolarToWorld( double, double, double &, double &, bool ) const;
  ...
  void AddDrawableObject( GRA_drawableObject * );
  ...
  void DrawLastTextString( GRA_outputType * );
  void RemoveLastTextString();
  GRA_drawableText *GetLastDrawableText();
