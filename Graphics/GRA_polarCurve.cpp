/*
Copyright (C) 2007,...,2008 Joseph L. Chuma, TRIUMF
...
void GRA_polarCurve::SetUp()
{
  ...
  xmax_ = static_cast<GRA_doubleCharacteristic*>(polarC->Get("MAX"))->Get();
}
...
void GRA_polarCurve::Make()
{
  switch ( histogramType_ )
  {
    case 1:
    case 3:
      MakeHistogramNoTails();   // profile parallel to x-axis
      break;
    case 2:
    case 4:
      MakeHistogramWithTails(); // profile parallel to x-axis
      break;
    default:
      MakeNonHistogram();
  }
...
void GRA_polarCurve::Draw( GRA_outputType *graphicsOutput )
{
  switch ( histogramType_ )
  {
    case 1:
...
void GRA_polarCurve::DrawNonHistogram( GRA_outputType *graphicsOutput )
{
...
void GRA_polarCurve::DrawHistogramNoTails( GRA_outputType *graphicsOutput )
{
  if( !areaFillColors_.empty() )
  {
    areaFillColor_ = areaFillColors_[0];
...
void GRA_polarCurve::DrawHistogramWithTails( GRA_outputType *graphicsOutput )
{
  std::size_t npt = r_.size();
  if( npt > 1 )
  {
